...
class WeekView: UIView {
    ...
    private let monLabel = UILabel().then {
        $0.text = "월"
        $0.textColor = .gray500
        $0.font = .pretendardFont(size: 16, weight: .semibold)
    }
    ...
    func setLayout() {
        ...
        tueLabel.snp.makeConstraints {
            $0.centerY.equalToSuperview()
            $0.leading.equalTo(monLabel.snp.trailing).offset(47)
            $0.height.equalTo(30)
        }
        wedLabel.snp.makeConstraints {
            $0.centerY.equalToSuperview()
            $0.leading.equalTo(tueLabel.snp.trailing).offset(46)
            $0.height.equalTo(30)
        }
        thuLabel.snp.makeConstraints {
            $0.centerY.equalToSuperview()
            $0.leading.equalTo(wedLabel.snp.trailing).offset(47)
            $0.height.equalTo(30)
        }
        friLabel.snp.makeConstraints {
            $0.centerY.equalToSuperview()
            $0.leading.equalTo(thuLabel.snp.trailing).offset(47)
            $0.height.equalTo(30)
        }
    }
}
